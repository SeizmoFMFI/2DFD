...
const char* Files::input_data		= "input/input_data.txt";
const char* Files::input_model		= "input/input_model.txt";
const char* Files::input_receivers	= "input/input_receivers.txt";
const char* Files::input_source		= "input/input_source.txt";
