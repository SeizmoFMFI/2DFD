...
extern void prepare_hom_medium(),smooth_by_gauss(const float n,float f[][DIM]),interpolate_muzx_from_mu();
...
extern float co_density,co_lam,co_mu,co_muzx,co_lam2mu,co_vP,co_vS;
#endif
